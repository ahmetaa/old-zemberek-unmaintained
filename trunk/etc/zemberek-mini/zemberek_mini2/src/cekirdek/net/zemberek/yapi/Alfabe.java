...
public class Alfabe {
    ...
    private String ozellik(Map<String, String> harfOzellikleri, String anahtar) {
        if (harfOzellikleri.containsKey(anahtar))
            ...
            System.out.println("harf ozelligi bulunamiyor: " + anahtar);
            return "";
        }
    }
    ...
    private char[] harfAyristir(String tum) {
        ...
        for (int i = 0; i < charStrDizi.length; i++) {
            if (charStrDizi[i].length() != 1)
                System.out.println(tum + "ayristirilirken tek harf bekleniyordu. " + charStrDizi + " uygun degil");
    ...
    private List<HarfCifti> harfCiftiAyristir(String tum) {
        ...
        for (String s : charStrDizi) {
            ...
            if (cift.length != 2)
                System.out.println(tum + "ayristirilirken harf cifti  bekleniyordu. " + s + " uygun degil.");
