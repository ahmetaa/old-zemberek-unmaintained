...
public class KaynakYukleyici {
    ...
    public InputStream getStream(String kaynakAdi) throws IOException {
        ...
        try {
            ...
            System.out.println("classpath kaynak erisimi saglandi:" + kaynakAdi + " kodlama:" + encoding);
        } catch (IOException e) {
            ...
            System.out.println("Proje ici kaynak erisimi saglandi:" + kaynakAdi + " kodlama:" + encoding);
        }
        return stream;
    }
