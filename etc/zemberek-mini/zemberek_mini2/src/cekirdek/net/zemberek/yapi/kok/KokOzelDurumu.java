...
public class KokOzelDurumu {
    ...
    public boolean olusabilirMi(Ek ek) {
        return herZamanOlusur ||
                sesliEkIleOlusur && ek.sesliIleBaslayabilirMi() ||
                gelebilecekEkler.contains(ek);
    }
    ...
    public boolean equals(Object o) {
        ...
        return tip.indeks() == that.tip.indeks() && tip.ad().equals(that.tip.ad());
