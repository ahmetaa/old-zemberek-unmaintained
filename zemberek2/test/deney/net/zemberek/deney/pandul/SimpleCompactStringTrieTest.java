...
public class SimpleCompactStringTrieTest extends TestCase {
  TurkishAlphabet alphabet = new TurkishAlphabet();
  public void testSingleChar() {
    SimpleCompactStringTrie cst = new SimpleCompactStringTrie(alphabet);
    cst.add("a");
  ...
  public void testSingleWord() {
    ...
    cst = new SimpleCompactStringTrie(alphabet);
    cst.add("a");
    cst.add("b");
  ...
  public void testCompactionLongChain() {
    ...
    System.out.println(cst.getRoot().dump(false));
    cst.compress();
    assertEquals ("#:(c)|cobansumbulu:.*|" , cst.getRoot().dump(true));
    System.out.println(cst.getRoot().dump(false));
  }  
  ...
  public void testSave() throws IOException {
    ...
    SimpleCompactStringTrie cst2 = new SimpleCompactStringTrie(alphabet);
